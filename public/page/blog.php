		...
		<main class="wrapperAboutPage">
			...
			<section class="pageBlog__Desctop">
				<aside class="column__1_blog js_static">
					...
					<ul class="ul_column__1_blog js_ul_menu">
						<li data-id="thema1" class="column__1_blog__line activeStroke_blogThema"><a href="#thema1" class="column__1_blog__line">Интересное в SASS</a></li>
						<li data-id="thema2" class="column__1_blog__line"><a href="#thema2" class="column__1_blog__line">Прыжки в Небо</a></li>
						<li data-id="thema3" class="column__1_blog__line"><a href="#thema3" class="column__1_blog__line"> Есть мечта - верь!</a></li>
					</ul>
				</aside>
				<div class="column__2_blog">
					<div data-section="thema1" id="thema1" class="block__column__2_blog">
						<div class="column__2__title BERNIERRegular">Интересное в SASS</div>
						<div class="column__2__date robotoLight">20 июля 2016</div>
						<div class="column__2__text robotoRegular">
