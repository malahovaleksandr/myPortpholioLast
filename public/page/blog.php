...
<html lang="ru">
	...
	<body>
		...
		<section class="pageBlog__Desctop">
			<div class="column__1_blog">
				<div class="column__1_blog__line activeStroke_blogThema">Интересное в SASS</div>
				<div class="column__1_blog__line">Прыжки в Небо</div>
				<div class="column__1_blog__line"> Есть мечта - верь!</div>
			</div>
			<div class="column__2_blog">
				<div class="block__column__2_blog">
